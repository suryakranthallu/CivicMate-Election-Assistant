...
SYSTEM_PROMPT = (
    ...
    "timelines (deadlines), or comparisons, you MUST also provide a "
    "structured JSON block at the very end of your response inside "
    "[CHART_DATA]...[/CHART_DATA] tags. Use the format: "
    "{\"type\": \"bar|line|pie\", \"labels\": [...], \"datasets\": "
    "[{\"label\": \"...\", \"data\": [...]}]}.\n\n"
