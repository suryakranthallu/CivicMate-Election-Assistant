...
SYSTEM_PROMPT = (
    ...
    "specific time to vote to avoid crowds (e.g., mid-morning at 11:00 AM or mid-afternoon "
    "at 3:30 PM). You MUST output a JSON block inside [CALENDAR_DATA]...[/CALENDAR_DATA] "
    "tags. Use format: {\"title\": \"Voting Day\", \"date\": \"20240520\", "
    "\"description\": \"Vote at Booth X\"}).\n\n"
    "REASONING TRACE: Before your final answer, you MUST provide a "
    "step-by-step reasoning block inside [REASONING]...[/REASONING] "
    "tags explaining which state the user is in and why you chose the voting time (if State 3).\n\n"
