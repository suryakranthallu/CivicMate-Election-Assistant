...
SYSTEM_PROMPT = (
    ...
    "ECOSYSTEM INTEGRATION: Whenever you mention a specific date or "
    "deadline, you MUST also provide a structured JSON block inside "
    "[CALENDAR_DATA]...[/CALENDAR_DATA] tags. Use the format: "
    "{\"title\": \"...\", \"date\": \"YYYYMMDD\", \"description\": \"...\"}.\n\n"
